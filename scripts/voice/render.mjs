// Julian's voice renderer (canonical): klattsch + LFO lanes + humanization transforms.
// Usage: node scripts/voice/render.mjs <out.wav> "<phoneme string>" ['<mods json>'] ['<humanize json>']
// The humanize lane exists for experiments only — Julian's voice does not use it
// (rejected in audition, 2026-08-08; see .claude/skills/speak/SKILL.md).
