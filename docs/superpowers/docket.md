...
**State:** done — test half shipped with #44 (main 704931e); live twin performed 2026-08-28 on julian-new from Chrome (offline compose → 1317 rows with divergent stamps → reconnect → one hash, no duplicates; U+2028/U+2029 byte-equal across a fresh full pull). Issue closed.
